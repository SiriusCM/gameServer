...
public class Start implements ServletContextListener, Runnable {
	...
	public void boot() {
		...
		try {
			ChannelFuture f1 = factory.createAccept(new ChannelInit(), bossGroup, workerGroup, 8888);
			ChannelFuture f2 = factory.createConnect(new ClientChannelInit(), workerGroup, "127.0.0.1", 8888);

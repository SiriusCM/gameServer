...
public class ClassUtil {
    ...
    public static ArrayList<Class> getAllClassByInterface(Class clazz) throws IOException, ClassNotFoundException {
    ...
    private static ArrayList<Class> getAllClass(String packagename) throws IOException, ClassNotFoundException {
        ArrayList<Class> list = new ArrayList<>();

...
public class ClassService implements IService {
    ...
    private final String CLASS_FILE_PREFIX = File.separator + "classes" + File.separator;

    private final String PACKAGE_SEPARATOR = ".";

    public List<String> getClazzName(String packageName, boolean showChildPackageFlag) {
    ...
    private List<String> getAllClassNameByFile(File file, boolean flag) {
        List<String> result = new ArrayList<>();
        if (!file.exists()) {
            return result;
        }
    ...
    private List<String> getAllClassNameByJar(JarFile jarFile, String packageName, boolean flag) {
        List<String> result = new ArrayList<>();
